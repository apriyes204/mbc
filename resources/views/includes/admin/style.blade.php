<!-- Favicons -->
<link href="{{ url('backend/assets/img/mbc.png') }}" rel="icon">
<link href="{{ url('backend/assets/img/mbc.png') }}" rel="apple-touch-icon">
...
{{-- <link href="{{ url('backend/assets/vendor/fas/css/fontawesome.min.css') }}" rel="stylesheet"> --}}
...
<link href="{{ url('backend/assets/vendor/simple-datatables/style.cs') }}s" rel="stylesheet">

<!-- Template Main CSS File -->
<link href="{{ url('backend/assets/css/style.css') }}" rel="stylesheet">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/5.0.1/css/bootstrap.min.css"
{{-- integrity="sha512-Nv7VWjz8GQrVUa1ULjT2XYYeAZ8DgM/jqbMjZONvPj/wc8h31E/hyAxYRK/XtI9XddNnFkqqjKt+kfDEtH2GzQ==" crossorigin="anonymous" referrerpolicy="no-referrer" --}}
/>