                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('asset.update', $asset->id) }}" method="POST">
                            ...
                            <div class="my-3">
                                ...
                                <input class="mb-3 form-control" type="text" value="{{ $asset->data_type_assets->nama_type }}"
                                    aria-label="Disabled input example" disabled readonly>

                                <select name="id_type" id="selectype" class="form-select">
                                    <option value="{{ $asset->id_type}}">Pilih Type Asset</option>
                            ...
                            <div class="my-3">
                                <label for="spesifikasiArea" class="form-label">Spesifikasi</label>
                                <textarea class="form-control" id="spesifikasiArea" name="spesifikasi" rows="8">{{ $asset->spesifikasi }}</textarea>
                            </div>
